      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        <label className="block text-sm">
          ...
          <select
            ...
            className="h-9 min-w-40 rounded-md border border-slate-200 bg-white px-2.5 text-sm text-slate-700 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/30 focus:outline-none disabled:opacity-50"
          >
