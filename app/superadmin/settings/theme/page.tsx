      ...
      render: (theme) => (
        <div className="flex items-center justify-end gap-1">
          ...
          <button
            ...
            title="Edit theme"
            className="rounded-md p-1.5 text-brand-700 transition-colors hover:bg-brand-50"
          >
            <Pencil size={15} />
          </button>
          <button
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-end">
        <button
          ...
          className="flex items-center gap-1.5 rounded-md bg-brand-600 px-4 py-2 text-sm font-semibold text-white shadow-premium-sm transition-all hover:-translate-y-0.5 hover:bg-brand-700 hover:shadow-premium"
        >
