  ...
  return (
    <div className="grid gap-4 lg:grid-cols-3">
      ...
      <div className="card-premium animate-fade-in-up relative overflow-hidden lg:col-span-1">
        <div className="h-12 bg-gradient-to-br from-forest-800 via-brand-700 to-brand-500" />
        <div className="flex flex-col items-center px-4 pb-4 text-center">
          <div className="-mt-7 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-brand-400 to-brand-600 text-sm font-semibold text-white shadow-glow-brand ring-4 ring-white">
            {initials}
          </div>
          <h2 className="mt-2 text-sm font-semibold text-slate-900">{profile?.fullName}</h2>
          {profile && (
            <span className="mt-1 rounded-full bg-brand-50 px-2.5 py-0.5 text-xs font-medium text-brand-700">
      ...
      <div className="space-y-4 lg:col-span-2">
        ...
        >
          <span className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-brand-600 via-brand-400 to-brand-600" />
