...
/**
 * Premium 02 — "Split": light split hero, an inset statistics card, and the
 * gallery sharing a row with "why choose us" above full-width testimonials.
 */
export default function Premium02Template({ site }: SiteTemplateProps) {
  ...
  if (site.shows.GALLERY || site.shows.WHY_CHOOSE) {
    blocks.push({
      id: 'gallery-why',
      keys: [
        ['GALLERY', 5],
      ...
      node: (
        <div className="mx-auto grid max-w-7xl gap-6 px-4 py-14 sm:px-6 lg:grid-cols-2">
          {site.shows.GALLERY && (
            <GallerySection items={site.galleryItems} copy={site.copy.gallery} layout="panel" ctaUrl="#gallery" />
          )}
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        {site.shows.HERO && <SplitHero site={site} />}
